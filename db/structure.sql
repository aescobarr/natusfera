...
--
-- Name: grid_0; Type: TABLE; Schema: public; Owner: -; Tablespace: 
--
...
CREATE TABLE photos (
    ...
    file_updated_at timestamp without time zone,
    metadata text,
    slider_url character varying(255)
);
...
--
-- Name: snap_grid_0; Type: TABLE; Schema: public; Owner: -; Tablespace: 
--

CREATE TABLE snap_grid_0 (
    cnt bigint,
    the_geom geometry
);
...
INSERT INTO schema_migrations (version) VALUES ('20161221141854');