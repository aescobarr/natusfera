...
class ApplicationController < ActionController::Base
  ...
  # filtre password temporal, eliminar
  ...
  # funcio filtre, eliminar
  #protected
   # def authenticate
    #  authenticate_or_request_with_http_basic "Acceso restringido, contacta con Bernat.Claramunt@uab.cat o a.escobar@creaf.uab.es para obtener las credenciales de acceso. Disculpad las molestias!" do |username, password|
     # username == "inates" && password == "n4tur4"
#    end
#  end
  ...
  def set_locale
    I18n.locale = params[:locale] || current_user.try(:locale) || cookies['locale'] || I18n.default_locale
